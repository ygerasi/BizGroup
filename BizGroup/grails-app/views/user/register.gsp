	...
	<body id="body">
		...
		<g:form action="register" name="registerForm" class="form form-horizontal">
			...
			<div class="input clearfix">
				...
				<g:textField required="true" name="jobTitle" value="${user?.jobTitle}" />
                <g:hasErrors  bean="${user}" field="jobTitle">
                    <p class="error"><g:fieldError bean="${user}" field="jobTitle" /></p>
                </g:hasErrors>
			</div>
			<div class="input clearfix">
