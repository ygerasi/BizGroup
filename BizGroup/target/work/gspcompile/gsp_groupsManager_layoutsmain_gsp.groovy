...
class gsp_groupsManager_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(6)
expressionOut.print(resource(dir: 'css', file: 'bizgroup.css'))
printHtmlPart(6)
...
printHtmlPart(12)
invokeTag('render','g',35,['template':("/user/welcomeMessage")],-1)
printHtmlPart(13)
}
printHtmlPart(13)
...
printHtmlPart(14)
invokeTag('layoutResources','r',45,[:],-1)
printHtmlPart(8)
})
invokeTag('captureBody','sitemesh',46,['class':("application")],1)
printHtmlPart(15)
}
...
public static final long LAST_MODIFIED = 1414435832757L
